...
class TestBurnerVisualization(unittest.TestCase):
    ...
    def test_combustion_analysis_plot(self):
        ...
        saved_files = self.viz.plot_combustion_analysis(
            self.sample_combustion_data, save_formats=["png"]
        )
    ...
    def test_pressure_losses_plot(self):
        ...
        saved_files = self.viz.plot_pressure_losses(self.sample_pressure_data, save_formats=["png"])
    ...
    def test_temperature_distribution_plot(self):
        ...
        saved_files = self.viz.plot_temperature_distribution(temperature_data, save_formats=["png"])
    ...
    def test_burner_geometry_plot(self):
        ...
        geometry_data = {
            "chamber": {"length": 2.0, "height": 1.0, "width": 1.5},
            "burner": {"width": 0.2, "height": 0.1, "position": "front"},
        }

        saved_files = self.viz.plot_burner_geometry(geometry_data, save_formats=["png"])
    ...
    def test_multiple_save_formats(self):
        ...
        formats = ["png", "pdf"]
        saved_files = self.viz.plot_combustion_analysis(
            self.sample_combustion_data, save_formats=formats
        )
    ...
    def test_export_all_visualizations(self):
        ...
        all_data = {
            ...
            "temperature": {
                "temperature_field": [[500, 600, 700], [600, 800, 900], [700, 900, 800]]
            },
            "geometry": {
        ...
        all_saved_files = self.viz.export_all_visualizations(all_data, save_formats=["png"])
