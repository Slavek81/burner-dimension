...
class TestChamberDesigner(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_combustion.calculate_combustion_products.return_value = self.mock_combustion_result
    ...
    def test_calculate_wall_temperature(self):
        ...
        self.assertLess(wall_temp_thick, wall_temp)  # Better insulation -> lower wall temp
    ...
    def test_different_insulation_thicknesses(self):
        ...
        # Better insulation should result in lower wall temperature and heat losses
        self.assertGreater(results[0].wall_temperature, results[2].wall_temperature)
        self.assertGreater(results[0].heat_loss_rate, results[2].heat_loss_rate)
        self.assertLess(results[0].thermal_efficiency, results[2].thermal_efficiency)
