...
class TestBurnerCalculatorGUI(unittest.TestCase):
    ...
    @patch('gui.ttk')
    @patch('gui.tk')
    def test_initialization_calculator_error(self, mock_tk, mock_ttk,
                                             mock_combustion, mock_messagebox):
    ...
    def test_perform_calculations_success(self):
        ...
        with patch.object(BurnerCalculatorGUI, '__init__', lambda x, y: None):
            ...
            gui.calculators['combustion'].\
                calculate_combustion_products.return_value = mock_combustion_result
            ...
            gui.calculators['radiation'].\
                calculate_flame_radiation.return_value = mock_radiation_result
    ...
    def test_perform_calculations_error_handling(self):
        ...
        with patch.object(BurnerCalculatorGUI, '__init__', lambda x, y: None):
            ...
            gui.calculators['combustion'].\
                calculate_combustion_products.side_effect = Exception("Calculation error")
