...
def demo_gui_functionality():
    ...
    sample_input = {
        ...
        "heat_release_density": 2000  # High density to reduce residence time
    }
    ...
    try:
        ...
        print(f"   - Teplota plamene: {combustion_results.adiabatic_flame_temperature-273.15:.0f} °C")
        ...
        try:
            ...
            print(f"   - Rozměry: ⌀{chamber_results.chamber_diameter*1000:.0f} × {chamber_results.chamber_length*1000:.0f} mm")
            ...
            print(f"   - Radiační tepelný tok: {radiation_results.total_heat_transfer/1000:.1f} kW")
            ...
            print(f"   - Celková tlaková ztráta: {pressure_results.total_pressure_loss:.0f} Pa")
