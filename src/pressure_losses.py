...
class PressureLossCalculator:
    ...
    def __init__(self, combustion_calculator: CombustionCalculator = None, safety_factor: float = 1.3):
        """
    ...
    def calculate_system_pressure_losses(
        ...
        for segment in pipe_segments:
            friction_loss, reynolds, friction_factor, velocity_pressure = self._calculate_pipe_friction_loss(
    ...
    def _calculate_pipe_friction_loss(
        ...
        friction_factor = self._calculate_friction_factor(reynolds, segment.roughness, segment.diameter)
    ...
    def optimize_pipe_diameter(
        ...
        for diameter in diameters:
            ...
            pressure_loss, reynolds, friction_factor, velocity_pressure = self._calculate_pipe_friction_loss(
...
def main():
    ...
    try:
        ...
        # System fittings
        fittings = [
            Fitting('pipe_entrance_rounded', 1, calc.get_fitting_coefficient('pipe_entrance_rounded'), 0.05),
